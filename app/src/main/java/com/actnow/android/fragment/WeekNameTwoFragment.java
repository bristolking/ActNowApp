...
public class WeekNameTwoFragment extends Fragment {
    RecyclerView mWeekTwoRecylcerView;
    ...
    final WeekNameTwoFragment context = this;

    TextView mTaskName;
    String id;

    TextView mWeekNameTwo;

    public WeekNameTwoFragment() {
    ...
    public class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private WeekNameTwoFragment.ClickListener clicklistener;
