...
import com.actnow.android.activities.insights.MonthlyTaskChartActivity;
import com.actnow.android.activities.insights.WeekelyTaskChartActivity;
...
public class YearlyTaskChartActivity extends AppCompatActivity implements OnChartGestureListener, OnChartValueSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yearly_task_chart);
        appHeaderTwo();
        initializeViews();
        appFooter();
        setData();
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        Intent i = new Intent(getApplicationContext(), WeekelyTaskChartActivity.class);
                        startActivity(i);
                        finish();
                        break;
                    case 3:
    ...
    public void onChartGestureEnd(MotionEvent me, ChartTouchListener.ChartGesture lastPerformedGesture) {
        ...
        if (lastPerformedGesture != ChartTouchListener.ChartGesture.SINGLE_TAP)
            ...
            mlineChartYearly.highlightValues(null);
    ...
    public void onValueSelected(Entry e, int dataSetIndex, Highlight h) {
        ...
        Log.i("LOWHIGH", "low: " + mlineChartYearly.getLowestVisibleXIndex()
                + ", high: " + mlineChartYearly.getHighestVisibleXIndex());

        Log.i("MIN MAX", "xmin: " + mlineChartYearly.getXChartMin()
                + ", xmax: " + mlineChartYearly.getXChartMax()
                + ", ymin: " + mlineChartYearly.getYChartMin()
                + ", ymax: " + mlineChartYearly.getYChartMax());
