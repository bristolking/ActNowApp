...
public class ThisWeekActivity extends AppCompatActivity {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.nav_thisweek:
                                Toast.makeText(getApplicationContext(), "Selected the Thisweek", Toast.LENGTH_SHORT).show();
                                break;
                        }
                        return false;
                    }
    ...
    private void initializeViews() {
        ...
        mThisweekrecyclerView.setAdapter(mTaskListAdapter);
        HashMap<String, String> userId = session.getUserDetails();
        String id = userId.get(UserPrefUtils.ID);
                    ...
                    mImageRaminder.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            ed_dateRaminder.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    new DatePickerDialog(ThisWeekActivity.this, date, remianderCalender
                            ...
                            ed_timeRemiander.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    mTimePicker = new TimePickerDialog(ThisWeekActivity.this, new TimePickerDialog.OnTimeSetListener() {
                                        @Override
