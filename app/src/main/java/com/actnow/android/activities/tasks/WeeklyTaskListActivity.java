...
public class WeeklyTaskListActivity extends AppCompatActivity {
    ...
    EditText mWeeklyTasklistQucikSearch;
    Button mWeeklyTaskListButtonAdavancedSearch;
    ImageView mWeeklyTaskListImageBulbTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weekly_task_list);
        appHeaderTwo();
        initializeViews();
        appFooter();
    }
    private void appHeaderTwo() {
        ...
        btnMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_weeklytaskList);
    ...
    private void initializeViews() {
        ...
        View view = (View)findViewById(R.id.liner_taskWeeklyList);
        ...
        mWeeklyTaskListImageBulbTask = findViewById(R.id.image_bulbWeeklyTaskList);
        mWeeklyTaskListImageBulbTask.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        mWeeklyTasklistQucikSearch = findViewById(R.id.edit_searchWeeklyTaskList);
        mWeeklyTasklistQucikSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        mWeeklyTaskListButtonAdavancedSearch = findViewById(R.id.button_searchWeeklyTaskList);
        mWeeklyTaskListButtonAdavancedSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "Work in Progress!", Toast.LENGTH_LONG).show();
            }
        ...
        mSpinnerWeeklyTaskList = (Spinner) findViewById(R.id.spinnerWeeklyTaskList);
        arrayAdapterWeekly = new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_dropdown_item_1line, repetitive);
        mSpinnerWeeklyTaskList.setAdapter(arrayAdapterWeekly);
        mSpinnerWeeklyTaskList.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ((TextView) mSpinnerWeeklyTaskList.getSelectedView()).setTextColor(getResources().getColor(R.color.colorAccent));
                switch (position) {
                    case 0:
        ...
        mRecyclerViewWeekly = findViewById(R.id.task_recyclerViewWeekely);
        mLayoutManager = new LinearLayoutManager(getApplicationContext());
        mRecyclerViewWeekly.setLayoutManager(mLayoutManager);
        mRecyclerViewWeekly.setItemAnimator(new DefaultItemAnimator());
        mTaskListAdapter = new TaskListAdapter(taskListRecordsArrayList, R.layout.task_list_cutsom, getApplicationContext());
        mRecyclerViewWeekly.setAdapter(mTaskListAdapter);
        HashMap<String, String> userId = session.getUserDetails();
        String id = userId.get(UserPrefUtils.ID);
                    ...
                    mImageRaminder.setOnClickListener( new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            ed_dateRaminder.setOnClickListener( new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    new DatePickerDialog( WeeklyTaskListActivity.this, date, remianderCalender
                            ...
                            ed_timeRemiander.setOnClickListener( new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    mTimePicker = new TimePickerDialog( WeeklyTaskListActivity.this, new TimePickerDialog.OnTimeSetListener() {
                                        @Override
    ...
    public class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private WeeklyTaskListActivity.ClickListener clicklistener;
        private GestureDetector gestureDetector;

        public RecyclerTouchListener(WeeklyTaskListActivity context, final RecyclerView mRecylerViewSingleSub, WeeklyTaskListActivity.ClickListener clickListener) {
