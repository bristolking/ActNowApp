...
public class DailyTaskListActivity extends AppCompatActivity {
    RecyclerView mDailyTaskListRecylcerView;
    RecyclerView.LayoutManager mLayoutManager;
    FloatingActionButton fabDailyTaskList;
    TaskListAdapter mTaskListAdapter;
    private ArrayList<TaskListRecords> taskListRecordsArrayList = new ArrayList<TaskListRecords>();
    View mProgressView, mContentLayout;
    UserPrefUtils session;
    Spinner mSpinnerDailyTaskList;
    ArrayAdapter<String> arrayAdapterDaily;
    ...
    EditText mDailyTasklistQucikSearch;
    ...
    public class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private DailyTaskListActivity.ClickListener clicklistener;
