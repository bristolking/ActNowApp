...
public class DailyTaskChartActivity extends AppCompatActivity implements OnChartGestureListener, OnChartValueSelectedListener {
    View mProgressView, mContentLayout;
    UserPrefUtils session;
    String[] arrayItems = {"Daily", "Weekley", "Monthly", "Yearly"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_today_task_chart);
        appHeader();
        initializeViews();
        appFooter();
        setData();
    ...
    private void appHeader() {
        ...
        btnCalendar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(DailyTaskChartActivity.this, MonthlyTaskListActivity.class);
                startActivity(i);
            }
        });
        ...
        btnSettings.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(DailyTaskChartActivity.this, SettingsActivity.class);
                startActivity(i);
            }
        });
    }
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        Intent iMonthley = new Intent(getBaseContext(), MonthlyTaskChartActivity.class);
                        startActivity(iMonthley);
                        finish();
                        break;
                    case 3:
                        Intent iYearly = new Intent(getBaseContext(), YearlyTaskChartActivity.class);
