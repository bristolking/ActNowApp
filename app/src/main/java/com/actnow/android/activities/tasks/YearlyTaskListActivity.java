...
public class YearlyTaskListActivity extends AppCompatActivity {
            ...
            public void onResponse(Call<TaskListResponse> call, Response<TaskListResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getSuccess().equals( "true" )) {
                        setYearlyTaskList( response.body().getTask_records() );
                    } else {
    ...
    private void setYearlyTaskList(List<TaskListRecords> taskListRecordsList) {
        if (taskListRecordsList.size() > 0) {
            for (int i = 0; taskListRecordsList.size() > i; i++) {
                ...
                System.out.println( "repeatType" + taskListRecords.getRepeat_type() );
