                    ...
                    mImageRaminder.setOnClickListener( new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            ed_dateRaminder.setOnClickListener( new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    new DatePickerDialog( YearlyTaskListActivity.this, date, remianderCalender
                            ...
                            ed_timeRemiander.setOnClickListener( new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    mTimePicker = new TimePickerDialog( YearlyTaskListActivity.this, new TimePickerDialog.OnTimeSetListener() {
                                        @Override
