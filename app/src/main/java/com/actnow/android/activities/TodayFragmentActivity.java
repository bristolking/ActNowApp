...
public class TodayFragmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_today_fragment );
    ...
    private void initializeViews() {
        ...
        if (orgn_code == null || TextUtils.isEmpty( orgn_code )) {
            Intent i = new Intent( getApplicationContext(), OrngActivity.class );
            startActivity( i );
        }
    ...
    public void checkPermission(String permission, int requestCode) {
        if (ContextCompat.checkSelfPermission( getApplicationContext(), permission ) == PackageManager.PERMISSION_DENIED) {
            ...
            ActivityCompat.requestPermissions( TodayFragmentActivity.this,
                    new String[]{permission},
                    requestCode );
        } else {
            Toast.makeText( TodayFragmentActivity.this, "Permission already granted", Toast.LENGTH_SHORT ).show();
        }
    }
        ...
        if (requestCode == CAMERA_PERMISSION_CODE) {
           ...
           /* if (grantResults.length > 0
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                Toast.makeText( TodayFragmentActivity.this,  "Storage Permission Granted", Toast.LENGTH_SHORT ).show();
            } else {
                Toast.makeText( TodayFragmentActivity.this,  "Storage Permission Denied", Toast.LENGTH_SHORT ).show();
            }
        }
    }
}
