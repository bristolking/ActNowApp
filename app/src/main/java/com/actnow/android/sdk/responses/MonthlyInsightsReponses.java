...
public class MonthlyInsightsReponses {
    private String success;
    private String message;
    private String no_of_tasks;
    private String no_of_ctasks;
    private List<MontnlyInsighsRepnseData> data;
    ...
    public List<MontnlyInsighsRepnseData> getData() {
        return data;
    }

    public void setData(List<MontnlyInsighsRepnseData> data) {
        this.data = data;
    }

    @Override
    public String toString() {
        return "MonthlyInsightsReponses{" +
                "success='" + success + '\'' +
                ", message='" + message + '\'' +
