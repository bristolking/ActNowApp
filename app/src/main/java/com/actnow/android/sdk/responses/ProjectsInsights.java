...
public class ProjectsInsights {
    ...
    public String getParent_project_code() {
        return parent_project_code;
    }

    public void setParent_project_code(String parent_project_code) {
        this.parent_project_code = parent_project_code;
    }
