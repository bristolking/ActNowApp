...
public class TaskDailyInsights {
    private String success;
    private String message;
    private String no_of_tasks;
    private String no_of_ctasks;
    private List<TaskDailyInsightsData> data;
    ...
    public List<TaskDailyInsightsData> getData() {
        return data;
    }

    public void setData(List<TaskDailyInsightsData> data) {
        this.data = data;
    }

    @Override
    public String toString() {
        return "TaskDailyInsights{" +
                "success='" + success + '\'' +
                ", message='" + message + '\'' +
