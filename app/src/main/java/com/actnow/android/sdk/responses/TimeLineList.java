...
public class TimeLineList {
    ...
    private List<TimeLineRecords>  timeline_records;
    ...
    public List<TimeLineRecords> getTimeline_records() {
        return timeline_records;
    }

    public void setTimeline_records(List<TimeLineRecords> timeline_records) {
