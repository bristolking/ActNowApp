...
public class PriorityOfflineAdapter extends RecyclerView.Adapter<PriorityOfflineAdapter.ViewHolder> {
    SortedList<TaskListRecords> list;

    public PriorityOfflineAdapter() {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new PriorityOfflineAdapter.ViewHolder( view );    }
